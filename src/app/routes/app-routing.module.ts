...
import { PciPalFailureComponent } from 'src/app/shared/components/pci-pal-failure/pci-pal-failure.component';
...
const routes: Routes = [
  ...
  {
    path: 'pci-pal-failure',
    component: PciPalFailureComponent
  },
  {
    path: 'fee-search',
