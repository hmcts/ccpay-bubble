...
  store: new redisStore({
    host: config.secrets.ccpay['bubble-frontend-redis-connection-string'],
...
// Logger.getLogger(`PAYBUBBLE:san.js1'} -> error`).info(config.secrets.ccpay['bubble-frontend-redis-connection-string']);
