...
const CCDNumberdivorce5 = faker.random.number(9999999999999909);
...
//    this.seeElement('div.one-full:nth-child(3) > div:nth-child(2) > input:nth-child(1):disabled');
 ...
 //   this.seeElement('div.one-full:nth-child(3) > div:nth-child(2) > input:nth-child(1):disabled');
  ...
  fullremissionforonefeeandonefeeforpartialremission() {
    ...
    this.click({ css: 'button.button' });
    this.click({ css: 'button.button:nth-child(4)' });
    this.click({ css: 'body > app-root > div > div > app-payment-history > ccpay-payment-lib > ccpay-case-transactions > div > main > div > div:nth-child(4) > div.govuk-inset-text.govuk-inset-text__no-border > div > button' });
    this.wait(CCPBConstants.fiveSecondWaitTime);
    this.see('100.00');
    this.see('99.99');
    this.see('0.01');
