module.exports = {
  ...
  TestWTPPBAAllAccountsUserPasword: process.env.FEE_PAY_WTP_PBA_ALL_ACCOUNTS_PASSWORD,
  TestWTPPBANoAccountsUserName: process.env.FEE_PAY_WTP_PBA_NO_ACCOUNTS_USERNAME,
  TestWTPPBANoAccountsUserPasword: process.env.FEE_PAY_WTP_NO_ALL_ACCOUNTS_PASSWORD,
